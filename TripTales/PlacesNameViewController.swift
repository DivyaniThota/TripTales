//
//  PlacesNameViewController.swift
//  TripTales
//
//  Created by DIVYANI PRASAD THOTA on 29/08/24.
//

import UIKit
import CoreData

class PlacesNameViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
